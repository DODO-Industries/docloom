...
if __name__ == "__main__" and (__package__ is None or __package__ == ""):
    ...
    from module_loom.services.weaver.substrate_layout import LoomSubstrate
else:
...
def main():
    if len(sys.argv) < 2:
        ...
        print("=" * 60)
        print("Usage:")
        print("  python module_loom/services/weaver/decode/brain_decoder.py <file_path>")
        print("  python module_loom/services/weaver/decode/brain_decoder.py <directory_path>")
        print("=" * 60)
        sys.exit(1)
